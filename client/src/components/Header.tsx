    ...
    return (
       <header className="bg-slate-200 shadow-md">
          <div className="flex justify-between items-center max-w-6xl mx-auto p-3">
             <Link to={"/"}>
                <h1
                   className="font-bold text-sm:text-xl flex flex-wrap"
                   style={{ border: "1px solid #edd", padding: "5px", borderRadius: "10px", backgroundColor: "#ddd" }}
                >
             ...
             <ul className="flex gap-4">
                ...
                <Link to={"/netblix"}>
                   <li className="hidden sm:inline text-slate-700 hover:underline">Netblix</li>
                </Link>
                <Link to={"/about"}>
